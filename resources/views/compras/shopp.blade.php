...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../style/styleShopp.css" />
...
<body class="corpoShopp">
    ...
    <div class="primeiroCard">
        <div class="card-group">
            <div class="card">
                <a href="#">
                    <img src="../imagem/akita.jpg" class="card-img-top" alt="akita">
                </a>
                <div class="card-body">
                    <a href="#" class="link1">
            ...
            <div class="card">
                <a href="#">
                    <img src="../imagem/basset.jpg" class="card-img-top" alt="basset">
                </a>
                <div class="card-body">
                    <a class="link1" href="#">
            ...
            <div class="card">
                <a href="#">
                    <img src="../imagem/beagle.jpg" class="card-img-top" alt="beagle">
                </a>
                <div class="card-body">
                    <a href="#" class="link1">
        ...
        <div class="card-group">
            <div class="card">
                <div class="card2imagem1">
                    <a href="#" class="link1">
                        <img src="../imagem/nSeiOnome.jpg" class="card-img-top" alt="bichonFrise">
                    </a>
                </div>
                <div class="card-body">
                    <a href="#" class="link1">
            ...
            <div class="card">
                <div class="card2imagem2">
                    <a href="#" class="link1">
                        <img src="../imagem/labrador.jpg" class="card-img-top" alt="borderCollie" style="height: 100%">
                    </a>
                </div>
                <div class="card-body">
                    <a href="#" class="link1">
            ...
            <div class="card">
                <div class="card2imagem3">
                    <a href="#" class="link1">
                        <img src="../imagem/chowchow.jpg" class="card-img-top" alt="boxer">
                    </a>
                </div>
                <div class="card-body">
                    <a class="link1" href="#">
